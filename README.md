...
OUTPUT RULES:
- DO NOT return banned values back in your responses. 
- EXAMPLE : DO NOT say "This word does not appear in the banned list, unlike "BANNEDWORD1" and "BANNEDWORD2".
- ONLY return the banned value if it is a VERY CLOSE match or obviously a confirmed match, return that value in the matched_words response.
